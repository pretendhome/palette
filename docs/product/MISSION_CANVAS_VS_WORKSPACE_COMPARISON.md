...
| **Knowledge** | palette_knowledge.json (170 entries) | palette_knowledge.json (168 + oil entries) |
...
| KL integration (170 entries) | ~50 | Shipped, tested | Direct + oil entries added |
