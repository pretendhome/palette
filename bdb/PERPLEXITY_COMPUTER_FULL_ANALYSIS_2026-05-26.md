...
- **Prize:** Up to 3 winners; $1M seed + $1M compute credits each
...
- **Explicit scoring criterion:** Computer (Perplexity's agent) usage — judges want to see Computer as co-builder, not just a research tool. This report was built with Computer. That is the answer to that criterion.
