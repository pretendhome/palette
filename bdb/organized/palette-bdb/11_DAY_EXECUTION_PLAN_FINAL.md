...
|-----------|--------|----------|
| Gateway + sanitizer | ✅ Shipped by Codex | 12/12 tests, governed boundary verified |
| `--external` flag in palette query | ✅ Wired | Governance trace surfaces in output |
| Perplexity API key | ⚠️ Recheck required | Live calls were previously confirmed; 2026-05-31 probe returned 401 Unauthorized. See `BDB_GATE_RECHECK_2026-05-31.md`. |
