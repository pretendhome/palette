...
## Overview
Palette is a multi-agent intelligence system for AI/ML decision routing. It combines 9 specialized agents, a 117-unit problem taxonomy, 136 knowledge entries, and 69 integration recipes to route any AI decision to the right combination of internal knowledge and external services.
...
├── taxonomy/         # 117 RIUs — problem-to-solution routing
├── knowledge-library/# 136 sourced, cited entries
├── buy-vs-build/     # Service routing, people signals, 69 integration recipes
