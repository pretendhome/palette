...
// Config holds all runtime configuration for the Debugger.
...
func defaultConfig() Config {
	return Config{
		...
		RoutePayload:  `{"input":{"objective":"debugger connectivity probe"}}`,
...
func buildFlags(cfg *Config) *flag.FlagSet {
	fs := flag.NewFlagSet("debugger", flag.ExitOnError)
