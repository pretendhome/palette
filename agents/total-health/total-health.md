...
1. **Knowledge Structure** — Taxonomy (121 RIUs), Knowledge Library (167), People Library (21), Relationship Graph (2,013 quads), Company Index
2. **Decision Infrastructure** — Service Routing (40), Integration Recipes (69), Classification, Service Name Mapping
