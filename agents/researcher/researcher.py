#!/usr/bin/env python3
"""
researcher.py — Researcher (Research Agent)
...
HandoffResult.output fields produced:
  ...
  next_agent   routing suggestion (architect | builder | validator | human)
...
{{
  ...
  "confidence": 0-100,
  "next_agent": "architect|builder|validator|human"
}}
...
- next_agent routing:
    architect  → architectural decisions or system design needed
    builder    → implementation or code changes needed
    validator  → validation, testing, or risk assessment needed
