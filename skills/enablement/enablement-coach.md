...
|---|---|
| **Research something** | Researcher agent: checks the knowledge library first (167 entries, instant), then runs targeted searches with citations. Can research with any lens — market analysis, competitive, technical, academic. |
