...
These are new signals that should also feed the **buy-vs-build** and **service routing**:

1. **Krea.ai**: In both Olivia Moore's personal AI stack AND Creandum's portfolio — double signal, add to buy-vs-build
...
5. **Granola** (AI meetings without visible bot): New tool not in buy-vs-build — high practitioner adoption signal (Olivia Moore uses it)
6. **Julius AI**: Data analysis tool recommended by a16z partner — not in buy-vs-build
