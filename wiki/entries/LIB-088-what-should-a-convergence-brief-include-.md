...
source_id: LIB-088
source_hash: sha256:05e186fbba8a5f0c
compiled_at: 2026-04-04T15:44:26Z
compiler_version: 1.0.0
type: knowledge_entry
evidence_tier: 3
tags: [all, knowledge-entry]
related: [RIU-001, RIU-004, RIU-005]
...
- **Tier 3 (entry-level)**: Palette UX Engagement - Cross-Domain Pattern 2 (`palette/docs/PERSONA_ARTIFACT_CONVERGENCE_BRIEF_2026-02-19.md`)
- **Tier 3 (entry-level)**: [Engineering Onboarding: The Key to DevEx Success](https://www.cortex.io/post/engineering-onboarding-the-key-to-devex-success)
...
Source: `knowledge-library/v1.4/palette_knowledge_library_v1.4.yaml`, entry LIB-088.
Evidence tier: 3.
Journey stage: all.
