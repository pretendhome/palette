...
source_id: LIB-107
source_hash: sha256:c89d49ee29e7b5d0
compiled_at: 2026-04-29T20:17:20Z
compiler_version: 1.0.0
type: knowledge_entry
evidence_tier: 3
tags: [all, budget, cfo, cost-reduction, knowledge-entry, roi]
...
# How do I quantify AI ROI for a CFO focused on cost reduction and budget shrinking, not revenue growth?
...
- Example: Walmart — 30% logistics savings
...
- Fully-loaded costs (not just licenses)
...
- **Tier 3 (entry-level)**: [Artefact Concentric ROI Framework](https://www.artefact.com/)
- **Tier 3 (entry-level)**: [IDC AI Business Value Benefit Framework](https://www.idc.com/)
- **Tier 3 (entry-level)**: [GetDX Multi-Phase Lifecycle Model](https://getdx.com/)
...
Source: `knowledge-library/v1.4/palette_knowledge_library_v1.4.yaml`, entry LIB-107.
Evidence tier: 3.
Journey stage: all.
